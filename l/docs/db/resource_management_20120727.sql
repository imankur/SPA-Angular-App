...
--
-- Definition of table `resource_management`.`employee_activity`
--

DROP TABLE IF EXISTS `resource_management`.`employee_activity`;
CREATE TABLE  `resource_management`.`employee_activity` (
  `activity_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned DEFAULT NULL,
  `activity_type` varchar(250) DEFAULT NULL,
  `field` varchar(250) DEFAULT NULL,
  `value` varchar(15000) DEFAULT NULL,
  `is_opened` bigint(20) unsigned DEFAULT NULL,
  `date_created` datetime DEFAULT NULL,
  `date_updated` datetime DEFAULT NULL,
  PRIMARY KEY (`activity_id`),
  KEY `FK_employee_activity_1` (`user_id`),
  CONSTRAINT `FK_employee_activity_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `resource_management`.`employee_activity`
--
...
--
-- Definition of table `resource_management`.`project_detail`
--

DROP TABLE IF EXISTS `resource_management`.`project_detail`;
CREATE TABLE  `resource_management`.`project_detail` (
  `project_detail_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_skill_detail_id` int(10) unsigned DEFAULT NULL,
  `project_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`project_detail_id`),
  KEY `FK_skill_detail_id` (`user_skill_detail_id`),
  KEY `FK_project_id` (`project_id`),
  CONSTRAINT `FK_project_id` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`),
  CONSTRAINT `FK_skill_detail_id` FOREIGN KEY (`user_skill_detail_id`) REFERENCES `user_skills_detail` (`user_skills_detail_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `resource_management`.`project_detail`
--
...
--
-- Definition of table `resource_management`.`projects`
--

DROP TABLE IF EXISTS `resource_management`.`projects`;
CREATE TABLE  `resource_management`.`projects` (
...
--
-- Dumping data for table `resource_management`.`projects`
--

/*!40000 ALTER TABLE `projects` DISABLE KEYS */;
INSERT INTO `resource_management`.`projects` (`project_id`,`project_name`) VALUES 
 (1,'EPK'),
 (2,'Equalizer'),
 (3,'DIMeX 2.0'),
 (4,'DIMeX 3.0'),
 ...
 (23,'TrackAndTrace'),
 (24,'Purolator'),
 (25,'StarsFileprocessor_Canlogix'),
 (26,'StarsFileprocessor_Keywill'),
 (27,'StarsFileprocessor_Trendset'),
 (28,'BackupDatabase'),
 (29,'MCOES'),
 (30,'MITL'),
 (31,'CPS3'),
 ...
 (34,'Atom'),
 (35,'IDS'),
 (36,'Mobile Research (Auto Taxi Fare)'),
 (37,'Dreamsbeachparty'),
 (38,'Internal Tools'),
 (39,'Marketing Tools'),
 (40,'Marketplace'),
 (41,'Release Builder'),
 (42,'ReleaseBuilder3.0'),
 (43,'SoundCloud'),
 (44,'Vector API');
INSERT INTO `resource_management`.`projects` (`project_id`,`project_name`) VALUES 
 (45,'Widget Streaming Player');
...
CREATE TABLE  `resource_management`.`user_skills_detail` (
  ...
  `last_used_month` varchar(250) DEFAULT NULL,
